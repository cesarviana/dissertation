...
Com relação ao tipo de interface, todos os trabalhos utilizam interface tangível, mas seguindo diferentes abordagens. O Robo-Blocks tem blocos eletrônicos, que são encaixados entre si e possuem um display que mostra o tamanho do avanço ou giro. O Cubetto também é programado por blocos tangíveis, porém a parte eletrônica está no painel onde os blocos são encaixados. Isso possivelmente diminui o custo com blocos em relação ao Robo-Blocks, e centraliza possíveis problemas eletrônicos no painel. O ALERT tem blocos ainda mais simples. Por captar qualquer tipo de marca fiducial, foram usadas folhas de papel com as marcas impressas, o que tente a ser mais barato e fácil de produzir em relação às outras ferramentas. A Bee-Bot, por sua vez, não é programada por blocos, mas sua interface de botões é tangível \cite{yu_review_2019}, bem como os elementos usados para controlar a mesa de realidade aumentada. Diferente das outras ferramentas, a Bee-Bot não favorece a visibilidade do algoritmo. Apesar das diferentes abordagens utilizadas, todos os trabalhos mencionam engajamento das crianças durante as interações, sejam elas com blocos eletrônicos ou com as folhas de papel.
