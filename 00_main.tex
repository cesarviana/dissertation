...
\newcommand{\falapessoa}[2]{
	{#1}: \fala{{#2}}
}

\newcommand{\citafalapessoa}[2]{
	\begin{citacao}
		{#1}: {#2}
	\end{citacao}
}
...
% ---
\titulo{RoPE AR}
\subtitulo{Uma Interface de Realidade Aumentada para Depuração de Algoritmos por Crianças de 4 a 6 anos}
...
%\numpaginas{175}
\palavraschave{Depuração, realidade aumentada, brinquedos programáveis, Design de Interação}
\keywords{Debugging, augmented reality, programmable toys, interaction design}
\englishmonth{September} 
\titleenglish{RoPE AR: An Augmented Reality Interface for Debugging Algorithms by Children 4-6 Years Old}
...
% ---
\include{1st_texts/folha_de_aprovacao.tex}
...
\include{03_estado_arte}
\include{04_desenvolvimento}
\include{05_avaliacao}
\include{06_resultados}
\include{07_conclusao}
