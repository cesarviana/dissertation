...
A análise dedutiva teve objetivo comparar as equipes e as atividades de programação e depuração. Ela segue a proposta de \citeonline{blikstein_analyzing_2014}, e inicia com uma definição prévia de códigos representando as ações das crianças. O \autoref{quadro:codigos} demonstra as ações mapeadas. 
...
\begin{quadro}[!h]
    ...
    \caption{}
     ...
     \begin{tabular}{@{}l m{.7\textwidth} c@{}}
        ...
        Reinicia & Após erro, coloca brinquedo na posição inicial \\ \hline % ação de depurar, pois "percebeu o erro"
...
% O que acontece depois que a criança percebe um erro?
% 1 - modificar - executar
% 2 - executar - modificar
% 3 - planejar - 
