...
Para a pergunta \pergunta{Q4 - Que tipos de problemas você percebe na proposta? Quais aspectos poderiam melhorar?}, as professoras consideraram não haver problemas perceptíveis na interface, ao menos do ponto de vista pedagógico.  Além disso, elas utilizaram adjetivos positivos para opinar sobre a RoPE AR:
...
Para a Q2 - \pergunta{Que importância você daria para a \destaque{visibilidade} no aprendizado das crianças?}, as professoras foram unânimes em afirmar a necessidade do contato com materiais concretos. De certo modo essa essas são respostas previsíveis, porém
