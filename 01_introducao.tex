...
Também não foi objetivo programar um algoritmo de visão computacional para reconhecer os blocos tangíveis e o RoPE. O uso de de uma biblioteca de identificação de marcas fiduciais foi a estratégia escolhida para agilizar a implementação. A eliminação de marcas fiduciais poderá ocorrer em trabalhos futuros, considerando os aprendizados obtidos com a primeira versão aqui apresentada.
