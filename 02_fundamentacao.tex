...
A facilidade de programar com blocos não se deve somente à visibilidade destes em um monitor fisicamente. A programação textual também mostra os comandos e ainda assim não é acessível para crianças. A vantagem dos blocos é que os comandos estão sempre disponíveis, geralmente agrupados por similaridade, de modo que não seja necessário lembrar sequências de caracteres para digitar num teclado. Além disso, o formato dos encaixes sugere como encaixar os blocos para produzir resultados coerentes. 
